...
### `Full Stack Developer` · `Vue.js` · `Node.js` · `React Native`
...
Desenvolvedor Full Stack com formação em **Gestão de TI** e especialização prática pela **Rocketseat** e **ProgramadorBR**. Trabalho construindo sistemas web e aplicativos que combinam arquitetura sólida com experiência de usuário de alto nível.

- 🔭 Atualmente desenvolvendo **Sistemas Web** e **PWAs** em produção
- ⚡ Stack principal: **Vue.js + PHP + Node.js**
- 📱 Mobile: **React Native** com publicação em produção
- 🏗️ Foco em **arquitetura limpa**, **escalabilidade** e **performance**
- 📍 Brasília, DF — Brasil
